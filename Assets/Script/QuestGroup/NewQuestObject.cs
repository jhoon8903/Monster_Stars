...
{
    public class NewQuestObject : MonoBehaviour
    {
        ...
        [SerializeField] private GameObject contentsItem1;
        [SerializeField] private GameObject contentsItem2;
        [SerializeField] private Slider contentsProgress;
        [SerializeField] private TextMeshProUGUI progressText;
        [SerializeField] private GameObject rewardBtn;
        [SerializeField] private GameObject contentLayout;
        [SerializeField] private Goods contentsItem;
        ...
        public void UpdateDesc()
        {
            ...
            {
                var savedLanguage = PlayerPrefs.GetString("Language", "ENG");
        ...
        {
            contentsProgress.value = progress;
            contentsProgress.maxValue = questGoal;
        }
        public void ShowItems()
        {
            contentsItem1.GetComponentInChildren<TextMeshProUGUI>().text = rewardCoin.ToString();
            contentsItem2.GetComponentInChildren<TextMeshProUGUI>().text =
        ...
        private void ShowCoin()
        {
            ...
            _coinObject = Instantiate(contentsItem, contentLayout.transform);
        ...
        private void ShowPiece()
        {
            ...
            foreach (var index in selectedUnitIndices)
            {
                ...
                _unitPieceObject = Instantiate(contentsItem, contentLayout.transform);
