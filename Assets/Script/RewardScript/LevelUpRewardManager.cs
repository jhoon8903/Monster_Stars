    ...
    public class LevelUpRewardManager : MonoBehaviour
    {
        ...
        private void LevelUpDisplayText(Button expButton, TMP_Text powerText, TMP_Text powerCode, Image btnBadge, ExpData powerUp, Language selectedLanguage)
        {
            ...
            powerText.text = powerUp.Type switch
            {
                ...
                ExpData.Types.WaterSlowDurationBoost => finalTranslation,
                ExpData.Types.WaterFreezeDamageBoost => finalTranslation,
                ExpData.Types.WaterSlowCPowerBoost => finalTranslation,
                ExpData.Types.WaterAttackRateBoost => finalTranslation,
                ExpData.Types.WaterGlobalFreeze => finalTranslation,
